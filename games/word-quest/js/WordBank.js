  ...
  constructor() {
    this.words = {
      ...
      explorer: {
        ...
        // Word families
        wordFamilies: {
          at: ["cat", "bat", "hat", "rat", "mat", "sat", "fat"],
          et: ["bet", "get", "let", "pet", "wet", "met", "net"],
          ig: ["big", "dig", "fig", "pig", "wig", "jig"],
          op: ["hop", "mop", "pop", "top", "cop", "stop"],
          ug: ["bug", "dug", "hug", "mug", "rug", "tug", "jug"],
      ...
      adventurer: {
        ...
        wordFamilies: {
          ake: ["make", "bake", "cake", "take", "wake", "shake", "brake"],
          ide: ["hide", "ride", "side", "wide", "slide", "bride"],
          one: ["bone", "cone", "tone", "zone", "phone", "stone"],
          ute: ["cute", "mute", "flute"],
          ain: ["rain", "pain", "main", "train", "brain", "chain"],
          eat: ["beat", "heat", "meat", "seat", "treat", "wheat"],
        },
