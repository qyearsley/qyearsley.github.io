...
- **Time-based difficulty**: Factor in how long it takes to answer
  - Fast correct answers → gradually increase difficulty
  - Slow answers (even if correct) → maintain or reduce difficulty slightly

- **Per-area difficulty tracking**: Each area could have its own difficulty level
  - Some kids might be great at addition but struggle with time-telling
...
- **Progressive hint reveal**:
  ...
  - Third attempt: Full visual hints

- **Earn hints with stars**:
  - Spend stars to reveal hints on difficult questions

- **Hint difficulty tiers**:
  - Level 1: Full emoji visualization
  - Level 2: Partial visualization (some hidden)
  - Level 3: Abstract representation only
  - Level 4: No visuals
...
- **Comparison questions**: "Which is larger: 15 or 23?"
...
- **Shape Space**: Geometry - identify shapes, count sides/corners
...
- **Font options**:
  - Replace Comic Sans with dyslexia-friendly fonts (OpenDyslexic, Lexie Readable)
...
- **Achievement badges**:
  - "Speed Demon" - 10 correct in under 30 seconds each
  - "Perfectionist" - Complete level with no wrong answers
  - "Persistent" - Complete level after making mistakes but trying again

- **Parent dashboard**:
  - View progress reports
  - See areas of strength/weakness
  - Set daily goals
...
- **Themes**: Seasonal themes (winter, spring, etc.)
...
- Prioritize features that directly help learning
