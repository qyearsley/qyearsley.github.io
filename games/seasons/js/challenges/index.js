 ...
 * the player to do.
 *
 * This is the indirection that keeps "Seasons" from being a maths game with a
 * story on top. A season names a challenge by string (`challenge:
 * "arithmetic"`), so when Ella invents a matching game, a word puzzle, or a
 * spot-the-difference, it is a new module in this directory, one line in
 * CHALLENGES, and one string in the season. No existing file changes shape.
 *
 ...
 *   play screen. See js/README.md for the one documented exception, where
 *   game.js reaches past this contract.
 *
